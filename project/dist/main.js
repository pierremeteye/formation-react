...
var Lilist = function Lilist(props) {
	return _react2.default.createElement(
		...
		props.todo.map(function (todos, i) {
			return _react2.default.createElement(
				'li',
				{ key: i },
				todos
...
Lilist.propTypes = {
	todo: _propTypes2.default.array.isRequired,
	user: _propTypes2.default.string.isRequired
};

var NotAdmin = function NotAdmin() {
	return _react2.default.createElement(
		'h1',
		null,
		'Vous n\'\xEAtes pas admin'
	);
};

var checkAdmin = function checkAdmin(WrappedComponent, name) {
	// return class CheckAdminComponent extends React.Component {
	return function (props) {
		if (props.user === name) {
			return _react2.default.createElement(WrappedComponent, props);
		} else {
			return _react2.default.createElement(NotAdmin, null);
		}
	};
	// }
};

var AdminOnlyLilist = checkAdmin(Lilist, 'admin');
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('input', { type: 'text', value: this.state.value, onChange: this.onTodoChange.bind(this) }),
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							null,
							function (user) {
								return _react2.default.createElement(AdminOnlyLilist, { user: user, todo: _this2.state.todo });
							}
						)
					)
				)
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_reactRouterDom.Route, { path: '/todo', component: Todo })
					)
				)
			);
		}
